...
```bash
pip install ExploratoryJupyterExtension
```
...
```bash
pip uninstall ExploratoryJupyterExtension
```
...
# Change directory to the ExploratoryJupyterExtension directory
...
folder is located. Then you can remove the symlink named `ExploratoryJupyterExtension` within that folder.
